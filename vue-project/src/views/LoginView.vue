<template>
  <div data-testid="login-page" class="auth-quiet min-h-screen flex items-center justify-center p-4">
    <div class="auth-panel bg-light/95 w-full max-w-md overflow-hidden border border-secondary/30">
      <div class="auth-heading p-6 text-center">
        ...
        <p class="text-dark/70 mt-2">登录后继续阅读、记录笔记和同步进度</p>
      </div>
      ...
      <div class="p-6">
        ...
        <div class="grid grid-cols-3 gap-4">
          <button type="button" aria-label="使用微信登录" @click="handleThirdPartyLogin" class="flex items-center justify-center p-3 border border-secondary/40 rounded-md hover:bg-secondary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent transition-colors duration-200">
            <i class="fab fa-weixin text-primary text-xl" aria-hidden="true"></i>
          </button>
          <button type="button" aria-label="使用 QQ 登录" @click="handleThirdPartyLogin" class="flex items-center justify-center p-3 border border-secondary/40 rounded-md hover:bg-secondary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent transition-colors duration-200">
            <i class="fab fa-qq text-primary text-xl" aria-hidden="true"></i>
          </button>
          <button type="button" aria-label="使用微博登录" @click="handleThirdPartyLogin" class="flex items-center justify-center p-3 border border-secondary/40 rounded-md hover:bg-secondary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent transition-colors duration-200">
