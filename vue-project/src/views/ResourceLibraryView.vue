<template>
  <div data-testid="resource-library-page" class="pt-24 pb-20 px-4 md:px-8 min-h-screen bg-gray-50">
    <!-- Hero 搜索区 -->
      ...
      <div class="container mx-auto max-w-4xl">
        ...
        <div class="relative max-w-2xl mx-auto">
          <input 
            ...
            type="text" 
            data-testid="resource-hero-search"
            placeholder="搜索资源..." 
          ...
          <button 
            @click="handleSearch"
            data-testid="resource-hero-search-submit"
    ...
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="lg:w-1/4 h-fit">
          <div data-testid="resource-filters" class="bg-white p-6 rounded-lg shadow-sm border border-secondary/20 sticky top-24">
            ...
            <div class="mb-6">
              ...
              <input 
                ...
                type="text" 
                data-testid="resource-sidebar-search"
            ...
            <button 
              @click="applyFilters" 
              data-testid="resource-apply-filters"
            ...
            <button 
              @click="resetFilters" 
              data-testid="resource-reset-filters"
        ...
        <main class="lg:w-3/4">
          ...
          <!-- 资源网格 -->
          <div v-if="paginatedResources.length > 0" data-testid="resource-card-list" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-12">
            <div 
          ...
          <!-- 无数据提示 -->
          <div v-else data-testid="resource-empty-state" class="text-center py-16 bg-white rounded-lg border border-dashed border-gray-300">
...
import { fetchResources, type ResourceItem } from '@/services/resourceService'
...
const mapApiResource = (resource: ResourceItem): Resource => ({
  id: resource.id,
  title: resource.title,
  description: resource.summary || resource.content || '',
  type: resource.resourceType,
  author: '平台资源',
  commentator: resource.tags?.[0] || '',
  era: '现代',
  rating: 5,
...
const loadResourcesFromBackend = async () => {
  try {
    ...
    if (response.data.length > 0) {
      allResources.value = response.data.map(mapApiResource)
    }
  } catch (error) {
    console.warn('资源库后端 API 不可用，继续使用本地示例数据:', error)
  }
}
...
const filteredResources = computed(() => {
  let result = allResources.value.filter(item => {
    // 搜索过滤
